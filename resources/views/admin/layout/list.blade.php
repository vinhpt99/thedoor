            ...
            <table class="table">
                ...
                @foreach($layouts as $key => $layout)
                        <tr>
                            ...
                            <td>
                                <a href="#" onclick="editLayout({{$layout->id}})" class="ml-2"><i class="fas fa-pencil-alt"></i></a>
                            </td>                                 
                            <td>
                                <a href="#" onclick="deleteLayout({{$layout->id}})" class="ml-2"><i  class="fa fa-times"></i></a>
                            </td>
                        </tr>
               @endforeach
                @endif
                        ...
                        <div class="col-md-12">
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group text-center">
                                    <button onclick="submitEditLayout()" type="submit" class="btn btn-primary"><i class="fas fa-sync pr-1"></i>Cập nhật</button>
                                </div>
                            </form>
                        </div>
                    </div>       
...
@section('script')
    ...
    {
        confirm("Bạn chắc muốn xóa layout này ?");      
          $.ajax({
               type: 'GET',
